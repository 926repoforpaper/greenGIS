...
const ProvinceEntityRepository = RepositoryFactory.get(
  "ProvinceEntityRepository"
);

export default {
  name: "provinceFormDetail",
  ...
  methods: {
    _fetchData(id) {
      ...
      return ProvinceEntityRepository.get(id)
