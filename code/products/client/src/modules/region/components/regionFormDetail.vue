...
const RegionEntityRepository = RepositoryFactory.get("RegionEntityRepository");

export default {
  name: "regionFormDetail",
  ...
  methods: {
    _fetchData(id) {
      ...
      return RegionEntityRepository.get(id)
