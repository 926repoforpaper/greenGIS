...
import townRouter from "./modules/town/router";
import municipalityRouter from "./modules/municipality/router";
import provinceRouter from "./modules/province/router";
import regionRouter from "./modules/region/router";
...
const routes = [
  ...
  {
    path: "/map-viewer/:id?/:lat?/:lng?/:zoom?",
    name: "MapViewer",
    meta: {
