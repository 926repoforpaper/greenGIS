...
public class MunicipalityFullDTO {
  ...
  public MunicipalityFullDTO() {}

  public MunicipalityFullDTO(Municipality municipality) {
    ...
    this.extension = municipality.getExtension();
  ...
  public Municipality toMunicipality() {
    ...
    municipality.setExtension(this.getExtension());
